...
namespace :db do
  ...
  task reset_pk: :environment do
    ActiveRecord::Base.connection.reset_pk_sequence!(Account.table_name)
    ...
    ActiveRecord::Base.connection.reset_pk_sequence!(Charge.table_name)
    ActiveRecord::Base.connection.reset_pk_sequence!(Debt.table_name)
    ...
    ActiveRecord::Base.connection.reset_pk_sequence!(DueOn.table_name)
