...
module DB
  ...
  describe 'ImportBillingProfile' do
    ...
    it "One row" do
      ...
      ImportBillingProfile.import Import.csv_table('address2',  headers: headers, drop_rows: 1, location:'spec/fixtures/import_data/billing_profile')
      expect(BillingProfile.first.use_profile).to be_true
    end

    it "One row, 2 Entities" do
      expect{ ImportBillingProfile.import Import.csv_table('address2',  headers: headers, drop_rows: 1, location:'spec/fixtures/import_data/billing_profile') }.to \
    ...
    context 'entities' do
      it 'adds one entity when second entity blank' do
        expect{ ImportBillingProfile.import Import.csv_table 'address2_one_entity',  headers: headers, drop_rows: 1, location:'spec/fixtures/import_data/billing_profile' }.to \
      ...
      context 'multiple imports' do
        ...
        it 'updated changed entities' do
          ImportBillingProfile.import Import.csv_table 'address2',  headers: headers, drop_rows: 1, location:'spec/fixtures/import_data/billing_profile'
          ImportBillingProfile.import Import.csv_table 'address2_updated',  headers: headers, drop_rows: 1, location:'spec/fixtures/import_data/billing_profile'
