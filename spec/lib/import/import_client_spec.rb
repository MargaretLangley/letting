  ...
  describe 'Import' do
    ...
    context 'entities' do
      it 'adds one entity when second entity blank' do
        expect{ ImportClient.import Import.csv_table 'clients_one_entity', location: 'spec/fixtures/import_data/clients' }.to \
          change(Entity, :count).by 1
      end

      it 'ordered by creation' do
        ImportClient.import Import.csv_table('clients', location: 'spec/fixtures/import_data/clients')
      ...
      context 'muliple imports' do
        ...
        it 'updated changed entities' do
          ImportClient.import Import.csv_table 'clients', location: 'spec/fixtures/import_data/clients'
          ImportClient.import Import.csv_table 'clients_updated', location: 'spec/fixtures/import_data/clients'
