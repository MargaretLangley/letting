...
module DB
  ...
  describe 'Import' do
    ...
    it "One row" do
      expect{ ImportClient.import Import.csv_table('clients', location: 'spec/import_data') }.to \
    ...
    context 'entities' do
      it 'adds one entity when second entity blank' do
        expect{ ImportClient.import Import.csv_table 'clients_one_entity', location: 'spec/import_data' }.to \
          change(Entity, :count).by 1
      end

      it 'ordered by creation' do
        ImportClient.import Import.csv_table('clients', location: 'spec/import_data')
      ...
      context 'muliple imports' do
        ...
        it 'updated changed entities' do
          ImportClient.import Import.csv_table 'clients', location: 'spec/import_data'
          ImportClient.import Import.csv_table 'clients_updated', location: 'spec/import_data'
