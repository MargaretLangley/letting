...
module DB
  ...
  describe 'ImportClient' do
    ...
    it "One row" do
      expect{ ImportClient.import Import.csv_table('clients', headers: headers, drop_rows: 1, location: 'spec/fixtures/import_data/clients') }.to \
    ...
    context 'entities' do
      it 'adds one entity when second entity blank' do
        expect{ ImportClient.import Import.csv_table 'clients_one_entity', headers: headers, drop_rows: 1, location: 'spec/fixtures/import_data/clients' }.to \
          change(Entity, :count).by 1
      end

      it 'ordered by creation' do
        ImportClient.import Import.csv_table('clients', headers: headers, drop_rows: 1, location: 'spec/fixtures/import_data/clients')
      ...
      context 'muliple imports' do
        ...
        it 'updated changed entities' do
          ImportClient.import Import.csv_table 'clients', headers: headers, drop_rows: 1, location: 'spec/fixtures/import_data/clients'
          ImportClient.import Import.csv_table 'clients_updated', headers: headers, drop_rows: 1, location: 'spec/fixtures/import_data/clients'
