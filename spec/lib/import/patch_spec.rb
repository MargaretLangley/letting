...
module DB
  ...
  describe 'Patch' do
    ...
    it 'if import file row id, matches patch row id - the models attributes are changed' do
      ImportClient.import   \
      Import.csv_table('clients', headers: ImportFields.client,
                                  location: clients_directory), \
      Patch.import(Client,
