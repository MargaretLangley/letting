...
describe Charge do
  let(:charge) do
    ...
    charge.due_on.new  day: 1, month: 1, charge_id: 1
    charge
  end
  ...
  context 'validations' do
    context 'presence' do
      ...
      xit('due_on') {charge.due_on.destroy_all; expect(charge).to_not be_valid}
    end
  end

  context 'Assocations' do
    it('is DueOns') { expect(charge).to respond_to(:due_on) }
  end
